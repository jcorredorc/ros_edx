  ...
  namespace simulation
  {
    ...
    struct GeometryTag
    {
      GeometryTag(const std::string &mesh_filename)
          : self(new TiXmlElement("geometry")), mesh(new TiXmlElement("mesh"))
      {
    ...
    struct MaterialTag
    {
      MaterialTag(const std::string &color_name = "medium_gray",
          ...
          : self(new TiXmlElement("material")), color(new TiXmlElement("color"))
      {
    ...
    struct InertialTag
    {
      InertialTag(const std::string &mass_value = "0.2",
                  ...
                  const OriginTag &origin_tag = OriginTag())
          : self(new TiXmlElement("inertial")), mass(new TiXmlElement("mass"))
      {
    ...
    struct RobotTag
    {
      RobotTag(const std::string &name,
          ...
          : self(new TiXmlElement("robot")), link(new TiXmlElement("link"))
      {
